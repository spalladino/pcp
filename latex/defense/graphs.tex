\newenvironment{coloredgraph}{
	\begin{tikzpicture}
		...
		sqpart/.style={fill=gray!10,rounded corners},
...
\newenvironment{freescaledcoloredgraph}[1]{
\begin{tikzpicture}
		[scale=#1, transform shape,
		n/.style= {minimum size=3mm,thick,circle,draw=black},
		b/.style= {minimum size=3mm,thick,circle,draw=black,fill=black},
...
\newcommand{\samplecoloredgraph}{
\begin{scaledcoloredgraph}{1}
...
\begin{scaledcoloredgraph}{1}
		...
		\begin{pgfonlayer}{background} 
			\node [sqpart,fit=(n0) (n1)] {}; 
			\node [sqpart,fit=(n2) (n3)] {}; 
			\node [sqpart,fit=(n4) (n5)] {}; 
		\end{pgfonlayer}
...
\newcommand{\samplepartitionedcoloredgraphA}{
\begin{freescaledcoloredgraph}{0.5}
