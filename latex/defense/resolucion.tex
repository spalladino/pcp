...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{chartbranchingstrategy.png}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{chartdsatur.png}
\end{figure}
...
\uncover<3->{
Por cada color que no se utilice en la solución inicial, se tienen $|V|+1$ variables menos.
}
