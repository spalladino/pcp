...
\begin{figure}[h]
	...
	\begin{tikzpicture} 
		...
		\node[n] (n3) at ( 2,2) {$t_1$}
			edge [-]	(n2)
			edge [-]	(n5)
			edge [<-, bend right, draw=blue!100] node[font=\tiny,auto] {$R_1$} 	(n0)
			edge [<-, bend left, draw=black!10] node[font=\tiny,auto,swap] {$R_2$} (n0)
		;
		...
		\node[n] (n7) at ( 3,1) {$t_2$}
			edge [-]	(n5)
			edge [<-, bend right, draw=black!10] node[font=\tiny,auto] {$R_3$}  (n6)
			edge [<-, bend left, draw=blue!100]	node[font=\tiny,auto,swap] {$R_4$} (n6) 
		;
