...
Every graph instance is run until the optimal solution is found, or for up to two hours.
...
\TODO{Analisis de la tabla anterior cuando esten los dos X\% faltantes, comentar gap no mayor a 1 color para frota, el siguiente para lo nuestro}
