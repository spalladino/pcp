 ...
 */
public abstract class MaxCliqueFinder implements Constants, Sorting, IBoundedAlgorithm {
	static final boolean checkClique = Settings.get().getBoolean("validate.cliques");
	
	protected SortedSimpleGraph graph;
	...
	public MaxCliqueFinder(IAlgorithmSource provider) {
		super();
